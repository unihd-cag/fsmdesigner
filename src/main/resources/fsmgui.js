...
//    {source: nodes[6], target: nodes[0], left: false, right: true }
  ];
...
function tick() {
  ...
  path.attr('d', function(d) {
    var deltaX = d.target.x - d.source.x,
        ...
        normX = deltaX / dist,
        normY = deltaY / dist,
        sourcePadding = d.left ? 25	: 12	//17 : 12,
        targetPadding = d.right ? 25 : 12			//17 : 12, old values
...
function restart() {
  ...
  circle.selectAll('circle')
    ...
    .classed('reflexive', function(d) { return d.reflexive; })
  	.classed('start_state', function(d) {return d.start_state; });
  
//  circle.selectAll('circle')
//  	.style('fill', function(d) { if(d.start_state == true) {return '#FFF';}});
...
//    		selected_node.reflexive = !selected_node.reflexive;
    		tableTab.append('svg:text')
				...
				.attr('font-size', 4)
				.attr('fill', '#000')
				.text(function() {return selected_node.text;});
    	}
    	restart();
    	break;
    case 68: //D
