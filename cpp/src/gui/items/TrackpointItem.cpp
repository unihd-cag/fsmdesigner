...
QVariant TrackpointItem::itemChange(GraphicsItemChange change,
	...
	if (change == QGraphicsItem::ItemSelectedHasChanged) {
        ...
        //check if previousTransline is valid, if so update Text
        if(this->getPreviousTransline() != nullptr)
        {
            QGraphicsItem * currentItem = this;
            QGraphicsItem * nextItem = this;

            //Get very first Transline
            while(nextItem->type() == TrackpointItem::Type)
            {
                currentItem = nextItem;
                nextItem = dynamic_cast<TrackpointItem*> (currentItem)->getPreviousTransline()->getStartItem();
            }

            //Save very first Transline in list
            ...
            //Go forward and save all Transitions in List
            ...
            Transline* tr = connectedTransitions.at(transAt);
