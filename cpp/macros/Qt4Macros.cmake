...
MACRO (QT4_WRAP_CPP outfiles )
  ...
  ## Check MOC Output dir exists
  IF (QT4_WRAP_CPP_OUT_DIR)
    FILE(MAKE_DIRECTORY ${QT4_WRAP_CPP_OUT_DIR})
  ENDIF(QT4_WRAP_CPP_OUT_DIR)
  ...
  FOREACH (it ${moc_files})
    ...
    IF (QT4_WRAP_CPP_OUT_DIR)
    	SET(outfile "${QT4_WRAP_CPP_OUT_DIR}moc_${it_name}.cxx")
    ELSE(QT4_WRAP_CPP_OUT_DIR)
...
MACRO (QT4_WRAP_UI outfiles )
  ...
  ## Check UI Output dir exists
  IF (QT4_WRAP_UI_OUT_DIR)
    FILE(MAKE_DIRECTORY ${QT4_WRAP_UI_OUT_DIR})
  ENDIF(QT4_WRAP_UI_OUT_DIR)
  ...
  FOREACH (it ${ui_files})
    ...
    IF (QT4_WRAP_UI_OUT_DIR)
    	SET(outfile ${QT4_WRAP_UI_OUT_DIR}/ui_${outfile}.h)
    ELSE(QT4_WRAP_UI_OUT_DIR)
...
MACRO (QT4_ADD_RESOURCES outfiles )
  ...
  FOREACH (it ${rcc_files})
    ...
    # Set outfile
     IF (QT4_ADD_RESOURCES_OUT_DIR)
    	SET(outfile ${QT4_ADD_RESOURCES_OUT_DIR}qrc_${outfilename}.cxx)
    ELSE(QT4_ADD_RESOURCES_OUT_DIR)
   		SET(outfile ${CMAKE_CURRENT_BINARY_DIR}qrc_${outfilename}.cxx)
   	ENDIF(QT4_ADD_RESOURCES_OUT_DIR)
