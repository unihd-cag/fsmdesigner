...
IF (QT4_QMAKE_FOUND)
  ...
  FOREACH(QT_MODULE ${QT_MODULES})
    ...
    FIND_PATH(QT_${_upper_qt_module}_INCLUDE_DIR ${QT_MODULE}
      ...
      MESSAGE(STATUS "Looking for module ${QT_MODULE} in ${QT_HEADERS_DIR}/${QT_MODULE}...${QT_${_upper_qt_module}_INCLUDE_DIR}" )
  ...
  FOREACH(QT_MODULE ${QT_MODULES})
    ...
    #MESSAGE(STATUS "Searching rel library for ${QT_MODULE}${QT_LIBINFIX} into ${QT_LIBRARY_DIR}: ${QT_${_upper_qt_module}_LIBRARY_RELEASE}")
    ...
    FIND_LIBRARY(QT_${_upper_qt_module}_LIBRARY_DEBUG
                 NAMES ${QT_MODULE}${QT_LIBINFIX} ${QT_MODULE}${QT_LIBINFIX}4
                 PATHS "/usr/lib/debug${QT_LIBRARY_DIR}" NO_DEFAULT_PATH
        )
